...
- (void)createUI {
    ...
    _likeBtn = [UIButton yhh_buttonWithSetProperty:^(UIButton *btn) {
        btn.yhh_title(@"喜欢", UIControlStateNormal)
        .yhh_titleColor(black_Text_Color, UIControlStateNormal)
        .yhh_titleColor(red_Globe_Color, UIControlStateSelected)
    ...
    _commentBtn = [UIButton yhh_buttonWithSetProperty:^(UIButton *btn) {
        btn.yhh_title(@"", UIControlStateNormal)
        .backgroundColor = random_Color;
        
        btn.frame = CGRectMake(_likeBtn.yhh_MaxX + 10, 0, _likeBtn.yhh_Width, 20);
